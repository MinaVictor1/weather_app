...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$GetWeatherStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  ...
  @override
  String toString() {
    return 'GetWeatherState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements GetWeatherState<T> {
...
class _$ErrorImpl<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'GetWeatherState<$T>.error(error: $error)';
  }
